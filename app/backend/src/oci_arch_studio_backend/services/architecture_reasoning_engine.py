...
REASONING_PROFILES: tuple[ReasoningProfile, ...] = (
    ...
    ReasoningProfile(
        ...
        triggers=("migration", "migrate", "aws", "eks", "rds", "s3", "cloudfront", "route53", "modernize"),
        intents=("migration", "modernization"),
        retrieval_terms=("migration waves", "compatibility", "cutover", "rollback", "Database Migration", "OKE"),
        service_priorities=("OCI Kubernetes Engine", "Database Migration", "Database Services", "Autonomous Database", "Object Storage", "Load Balancer", "Logging", "Monitoring"),
    ...
    ReasoningProfile(
        name="saas_platform",
        triggers=("saas", "tenant", "multi-tenant", "multi tenant", "shared service", "multi-region"),
        intents=("saas_platform", "architecture", "dr"),
        retrieval_terms=("tenant isolation", "cost allocation", "shared services", "data residency", "multi-region"),
        service_priorities=("Load Balancer", "OCI Kubernetes Engine", "Database Services", "Autonomous Database", "Object Storage", "Identity and Access Management", "Vault", "Monitoring", "Cost Management"),
        architecture_patterns=("tenant-isolation", "multi-region-ha", "network-isolation", "cost-allocation"),
        workload_types=("saas-platform", "webapp", "enterprise-app"),
        risk_emphasis=("tenant isolation", "noisy-neighbor risk", "data residency", "shared-service blast radius"),
        tradeoff_dimensions=("simplicity_vs_scalability", "latency_vs_multi_region_resilience", "cost_vs_resilience"),
        recommendation_guidance=(
            "Make tenancy isolation, shared-service boundaries, cost attribution, and region strategy explicit.",
        ),
    ),
    ReasoningProfile(
