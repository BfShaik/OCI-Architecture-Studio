...
REASONING_PROFILES: tuple[ReasoningProfile, ...] = (
    ...
    ReasoningProfile(
        ...
        retrieval_terms=("tenant isolation", "cost allocation", "shared services", "data residency", "multi-region", "observability"),
        service_priorities=("Load Balancer", "OCI Kubernetes Engine", "Database Services", "Autonomous Database", "Object Storage", "Identity and Access Management", "Vault", "Logging", "Monitoring", "Cost Management"),
