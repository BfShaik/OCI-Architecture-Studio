...
class Settings(BaseSettings):
    ...
    deployment_profile: str = Field(default="local_dev", alias="DEPLOYMENT_PROFILE")
    ...
    oci_vault_config_secret_ocid: str | None = Field(default=None, alias="OCI_VAULT_CONFIG_SECRET_OCID")
    oci_logging_log_group_ocid: str | None = Field(default=None, alias="OCI_LOGGING_LOG_GROUP_OCID")
    oci_monitoring_namespace: str = Field(default="oci_architecture_studio", alias="OCI_MONITORING_NAMESPACE")
    oci_notifications_topic_ocid: str | None = Field(default=None, alias="OCI_NOTIFICATIONS_TOPIC_OCID")
    oci_events_rule_ocid: str | None = Field(default=None, alias="OCI_EVENTS_RULE_OCID")
    oci_api_gateway_endpoint: str | None = Field(default=None, alias="OCI_API_GATEWAY_ENDPOINT")
